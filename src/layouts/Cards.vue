<template>    
    <section class="cards">
        <div class="hidden lg:grid grid-cols-1 lg:grid-cols-3 pt-16 px-16 gap-11 relative">

            <svg class="hidden lg:block absolute 
                top-[130px] left-1/3 -translate-x-1/2 
                w-[35%] h-[30px]" viewBox="0 0 300 60" fill="none">

                <path d="M0 50 
               C50 -10, 120 -10, 160 30 
               S250 50, 300 0" stroke="#BDBDBD" stroke-width="4" stroke-dasharray="10 5" fill="none" />
            </svg>

            <svg class="hidden lg:block absolute 
                top-[130px] left-2/3 -translate-x-1/2 
                w-[35%] h-[30px]" viewBox="0 0 300 60" fill="none">
